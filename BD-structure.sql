...
ALTER TABLE `organisation` ADD CONSTRAINT `organisation_id_org_fk` FOREIGN KEY (`id_org`) REFERENCES `org_configs` (`id_org`);
...
ALTER TABLE `menu` ADD CONSTRAINT `menu_id_org_fk` FOREIGN KEY (`id_org`) REFERENCES `organisation` (`id_org`);
